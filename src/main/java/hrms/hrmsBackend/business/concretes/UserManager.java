 ...
 * 
 * @Service public class UserManager implements UserService{
 * 
 * private UserDao userDao;
 * 
 * @Autowired public UserManager(UserDao userDao) { super(); this.userDao =
 * userDao; }
 * 
 * @Override public Result add(User user) {
 * 
 * this.userDao.save(user); return new SuccessResult("Kullanıcı kayıt oldu"); }
 * 
 * 
 * @Override public DataResult<List<User>> getAll() {
 * 
